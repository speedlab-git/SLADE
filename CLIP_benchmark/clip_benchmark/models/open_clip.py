...
# def load_open_clip(model_name: str = "ViT-B-32-quickgelu", pretrained: str = "C:\CodesSpring24\RobustVLM\cocoadv\fare_eps_4.pt", cache_dir: str = None, device="cpu"):
#     pretrained=r"C:\CodesSpring24\RobustVLM\cocoadv\fare_eps_4.pt"
#     try:
